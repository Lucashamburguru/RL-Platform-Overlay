...
pub(super) fn rank_icon(rank: &str) -> Option<egui::ImageSource<'static>> {
    let rank_trimmed = rank.trim();
    // Avoid String allocation in the render loop by using eq_ignore_ascii_case
    if rank_trimmed.eq_ignore_ascii_case("bronze i") {
        Some(egui::include_image!("../../assets/ranks/bronze_1.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("bronze ii") {
        Some(egui::include_image!("../../assets/ranks/bronze_2.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("bronze iii") {
        Some(egui::include_image!("../../assets/ranks/bronze_3.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("silver i") {
        Some(egui::include_image!("../../assets/ranks/silver_1.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("silver ii") {
        Some(egui::include_image!("../../assets/ranks/silver_2.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("silver iii") {
        Some(egui::include_image!("../../assets/ranks/silver_3.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("gold i") {
        Some(egui::include_image!("../../assets/ranks/gold_1.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("gold ii") {
        Some(egui::include_image!("../../assets/ranks/gold_2.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("gold iii") {
        Some(egui::include_image!("../../assets/ranks/gold_3.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("platinum i") {
        Some(egui::include_image!("../../assets/ranks/platinum_1.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("platinum ii") {
        Some(egui::include_image!("../../assets/ranks/platinum_2.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("platinum iii") {
        Some(egui::include_image!("../../assets/ranks/platinum_3.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("diamond i") {
        Some(egui::include_image!("../../assets/ranks/diamond_1.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("diamond ii") {
        Some(egui::include_image!("../../assets/ranks/diamond_2.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("diamond iii") {
        Some(egui::include_image!("../../assets/ranks/diamond_3.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("champion i") {
        Some(egui::include_image!("../../assets/ranks/champion_1.png"))
    } else if rank_trimmed.eq_ignore_ascii_case("champion ii") {
